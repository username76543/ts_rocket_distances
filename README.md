...
2. Exclude high dimensionality for the same reasons.
3. Series Length above 9, since ROCKET requires at least a series length of 8.
4. Avoid excessive number of datapoints. Most of these are in MONSTER and I am just trying this idea out on my personal box, not trying for top performance.
